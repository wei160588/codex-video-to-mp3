...
<img width="944" height="783" alt="app-running" src="https://github.com/user-attachments/assets/34a50c3d-1f1b-40e3-9a58-33697b05fb3e" />
# codex-video-to-mp3
...
![App running on Windows](app-running.jpg)

### MP3 output proof
![MP3 output proof](mp3-output-proof.jpg)

### Project structure
![Project structure](project-structure.jpg)

### AI-assisted build result
![AI-assisted build result](codex-build-result.jpg)
